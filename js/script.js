...
$( document ).ready(function() {
	...
	$("button").click(function(){
		addSong(i);
		$("body").append("<h3>" + addSong(i).title + "</h3>");
		$("body").append("<p>" + addSong(i).artist + "</p>");
		$("body").append("<p>" + "<a href =" + addSong(i).mp3Url + ">listen</a>" + "</p>");
		$("body").append("<p>" + "<img src =" + addSong(i).imageUrl + ">" + "</p>");
	});
});